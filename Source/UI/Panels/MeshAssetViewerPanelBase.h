...
protected:
	...
	bool RebuildMaterialForSubMesh(MeshGeometry* subMesh, const std::string& materialPath) const;
	void InitializeMaterialForSubMesh(MeshGeometry* subMesh) const;
	Vector4 GetMaterialSlotVisualizerColor(size_t subMeshIndex) const;
	Material* CreateInitializedPreviewDefaultMaterial(MeshGeometry* subMesh, const char* materialName) const;
	Material* CreateInitializedMaterialSlotVisualizerMaterial(MeshGeometry* subMesh, const char* materialName) const;
