...
void ShaderEditorPanel::CompileGraphToMaterial(MaterialInitializationData* outMaterialData)
{
	...
	ShaderGraphCompileInput compileInput;
	compileInput.nodes = &nodes_;
	compileInput.links = &links_;
	compileInput.textures = &textures_;
	compileInput.masterNodeId = masterNodeId_;

	ShaderGraphCompiler compiler;
	compiler.CompileMaterial(compileInput, outMaterialData);
}
